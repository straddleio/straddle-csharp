...
/// </summary>
public record class PayoutUploadAuthorizationDocumentParams : ParamsBase
{
    ...
    public PayoutUploadAuthorizationDocumentParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PayoutUploadAuthorizationDocumentParams(
        PayoutUploadAuthorizationDocumentParams payoutUploadAuthorizationDocumentParams
    )
        : base(payoutUploadAuthorizationDocumentParams)
    {
        this.ID = payoutUploadAuthorizationDocumentParams.ID;

        this._rawBodyData = new(payoutUploadAuthorizationDocumentParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PayoutUploadAuthorizationDocumentParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, MultipartJsonElement> rawBodyData,
        string id
    ...
    public virtual bool Equals(PayoutUploadAuthorizationDocumentParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/payouts/{0}/authorization", this.ID)
        )
        {
