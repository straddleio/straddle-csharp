...
/// </summary>
public record class PayoutGetParams : ParamsBase
{
    ...
    public PayoutGetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PayoutGetParams(PayoutGetParams payoutGetParams)
        : base(payoutGetParams)
    {
        this.ID = payoutGetParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PayoutGetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(PayoutGetParams? other)
    {
        if (other == null)
        {
            return false;
