...
/// </summary>
public record class PayoutUnmaskParams : ParamsBase
{
    ...
    public PayoutUnmaskParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PayoutUnmaskParams(PayoutUnmaskParams payoutUnmaskParams)
        : base(payoutUnmaskParams)
    {
        this.ID = payoutUnmaskParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PayoutUnmaskParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(PayoutUnmaskParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/payouts/{0}/unmask", this.ID)
        )
        {
