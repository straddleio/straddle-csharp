...
/// to be enabled by Straddle for your account and should only be used when absolutely necessary.
///
/// <para>NOTE: Do not inherit from this type outside the SDK unless you're okay with
/// breaking changes in non-major versions. We may add new methods in the future that
/// cause existing derived classes to break.</para>
/// </summary>
public record class LinkedBankAccountUnmaskParams : ParamsBase
{
    ...
    public LinkedBankAccountUnmaskParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public LinkedBankAccountUnmaskParams(
        LinkedBankAccountUnmaskParams linkedBankAccountUnmaskParams
    )
        : base(linkedBankAccountUnmaskParams)
    {
        this.LinkedBankAccountID = linkedBankAccountUnmaskParams.LinkedBankAccountID;
    }
...
#pragma warning restore CS8618
    ...
    public static LinkedBankAccountUnmaskParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string linkedBankAccountID
    )
    ...
    public virtual bool Equals(LinkedBankAccountUnmaskParams? other)
    {
        if (other == null)
        {
            return false;
