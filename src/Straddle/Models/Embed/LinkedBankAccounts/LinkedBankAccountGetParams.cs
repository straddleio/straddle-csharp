...
/// </summary>
public record class LinkedBankAccountGetParams : ParamsBase
{
    ...
    public LinkedBankAccountGetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public LinkedBankAccountGetParams(LinkedBankAccountGetParams linkedBankAccountGetParams)
        : base(linkedBankAccountGetParams)
    {
        this.LinkedBankAccountID = linkedBankAccountGetParams.LinkedBankAccountID;
    }
...
#pragma warning restore CS8618
    ...
    public static LinkedBankAccountGetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(LinkedBankAccountGetParams? other)
    {
        if (other == null)
        {
            return false;
