...
/// </summary>
public record class LinkedBankAccountCancelParams : ParamsBase
{
    ...
    public LinkedBankAccountCancelParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public LinkedBankAccountCancelParams(
        LinkedBankAccountCancelParams linkedBankAccountCancelParams
    )
        : base(linkedBankAccountCancelParams)
    {
        this.LinkedBankAccountID = linkedBankAccountCancelParams.LinkedBankAccountID;
    }
...
#pragma warning restore CS8618
    ...
    public static LinkedBankAccountCancelParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(LinkedBankAccountCancelParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/linked_bank_accounts/{0}/cancel", this.LinkedBankAccountID)
        )
        {
