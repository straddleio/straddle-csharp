...
/// </summary>
public record class OrganizationCreateParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public OrganizationCreateParams(OrganizationCreateParams organizationCreateParams)
        : base(organizationCreateParams)
    {
        this._rawBodyData = new(organizationCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static OrganizationCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(OrganizationCreateParams? other)
    {
        if (other == null)
        {
            return false;
