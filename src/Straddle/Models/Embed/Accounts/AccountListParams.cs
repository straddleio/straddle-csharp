...
/// The accounts are returned sorted by creation date, with the most recently created
/// accounts appearing first. This endpoint supports advanced sorting and filtering options.
///
...
public record class AccountListParams : ParamsBase
{
    ...
    public ApiEnum<string, global::Straddle.Models.Embed.Accounts.Type>? Type
    {
        get
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<
                ApiEnum<string, global::Straddle.Models.Embed.Accounts.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::Straddle.Models.Embed.Accounts.Type>
{
    public override global::Straddle.Models.Embed.Accounts.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "business" => global::Straddle.Models.Embed.Accounts.Type.Business,
            _ => (global::Straddle.Models.Embed.Accounts.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Straddle.Models.Embed.Accounts.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Straddle.Models.Embed.Accounts.Type.Business => "business",
                _ => throw new StraddleInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
