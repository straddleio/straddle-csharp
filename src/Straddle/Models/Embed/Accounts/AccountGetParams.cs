...
/// </summary>
public record class AccountGetParams : ParamsBase
{
    ...
    public AccountGetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AccountGetParams(AccountGetParams accountGetParams)
        : base(accountGetParams)
    {
        this.AccountID = accountGetParams.AccountID;
    }
...
#pragma warning restore CS8618
    ...
    public static AccountGetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AccountGetParams? other)
    {
        if (other == null)
        {
            return false;
