...
/// </summary>
public record class ChargeUnmaskParams : ParamsBase
{
    ...
    public ChargeUnmaskParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChargeUnmaskParams(ChargeUnmaskParams chargeUnmaskParams)
        : base(chargeUnmaskParams)
    {
        this.ID = chargeUnmaskParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static ChargeUnmaskParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ChargeUnmaskParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/charges/{0}/unmask", this.ID)
        )
        {
