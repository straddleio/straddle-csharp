...
/// </summary>
public record class ChargeHoldParams : ParamsBase
{
    ...
    public ChargeHoldParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChargeHoldParams(ChargeHoldParams chargeHoldParams)
        : base(chargeHoldParams)
    {
        this.ID = chargeHoldParams.ID;

        this._rawBodyData = new(chargeHoldParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ChargeHoldParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(ChargeHoldParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + string.Format("/v1/charges/{0}/hold", this.ID)
        )
        {
