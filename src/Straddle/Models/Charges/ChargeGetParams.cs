...
/// </summary>
public record class ChargeGetParams : ParamsBase
{
    ...
    public ChargeGetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChargeGetParams(ChargeGetParams chargeGetParams)
        : base(chargeGetParams)
    {
        this.ID = chargeGetParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static ChargeGetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ChargeGetParams? other)
    {
        if (other == null)
        {
            return false;
