...
/// </summary>
public record class PaykeyGetParams : ParamsBase
{
    ...
    public PaykeyGetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PaykeyGetParams(PaykeyGetParams paykeyGetParams)
        : base(paykeyGetParams)
    {
        this.ID = paykeyGetParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PaykeyGetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(PaykeyGetParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + string.Format("/v1/paykeys/{0}", this.ID)
        )
        {
