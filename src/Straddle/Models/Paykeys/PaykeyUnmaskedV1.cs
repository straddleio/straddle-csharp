...
sealed class PaykeyUnmaskedV1DataSourceConverter : JsonConverter<PaykeyUnmaskedV1DataSource>
{
    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            "mastercard" => PaykeyUnmaskedV1DataSource.Mastercard,
    ...
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ...
                PaykeyUnmaskedV1DataSource.Mastercard => "mastercard",
                _ => throw new StraddleInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
    ...
    : JsonConverter<PaykeyUnmaskedV1DataStatusDetailsReason>
{
    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            "validating" => PaykeyUnmaskedV1DataStatusDetailsReason.Validating,
            "auto_hold" => PaykeyUnmaskedV1DataStatusDetailsReason.AutoHold,
    ...
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ...
                PaykeyUnmaskedV1DataStatusDetailsReason.Validating => "validating",
                PaykeyUnmaskedV1DataStatusDetailsReason.AutoHold => "auto_hold",
                _ => throw new StraddleInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
