...
/// </summary>
public record class PaykeyUpdateBalanceParams : ParamsBase
{
    ...
    public PaykeyUpdateBalanceParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PaykeyUpdateBalanceParams(PaykeyUpdateBalanceParams paykeyUpdateBalanceParams)
        : base(paykeyUpdateBalanceParams)
    {
        this.ID = paykeyUpdateBalanceParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static PaykeyUpdateBalanceParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(PaykeyUpdateBalanceParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v1/paykeys/{0}/refresh_balance", this.ID)
        )
        {
