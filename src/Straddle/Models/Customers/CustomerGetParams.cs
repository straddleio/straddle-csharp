...
/// </summary>
public record class CustomerGetParams : ParamsBase
{
    ...
    public CustomerGetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CustomerGetParams(CustomerGetParams customerGetParams)
        : base(customerGetParams)
    {
        this.ID = customerGetParams.ID;
    }
...
#pragma warning restore CS8618
    ...
    public static CustomerGetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CustomerGetParams? other)
    {
        if (other == null)
        {
            return false;
