...
/// </summary>
public record class BridgeInitializeParams : ParamsBase
{
    ...
    public BridgeInitializeParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BridgeInitializeParams(BridgeInitializeParams bridgeInitializeParams)
        : base(bridgeInitializeParams)
    {
        this._rawBodyData = new(bridgeInitializeParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static BridgeInitializeParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(BridgeInitializeParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/bridge/initialize")
        {
