...
/// </summary>
public record class LinkBankAccountParams : ParamsBase
{
    ...
    public LinkBankAccountParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public LinkBankAccountParams(LinkBankAccountParams linkBankAccountParams)
        : base(linkBankAccountParams)
    {
        this._rawBodyData = new(linkBankAccountParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static LinkBankAccountParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(LinkBankAccountParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/bridge/bank_account")
        {
