...
public class ChargeUnmaskParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ChargeUnmaskParams
        {
    ...
    {
        var parameters = new ChargeUnmaskParams { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
    ...
    {
        ChargeUnmaskParams parameters = new() { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ChargeUnmaskParams copied = new(parameters);
