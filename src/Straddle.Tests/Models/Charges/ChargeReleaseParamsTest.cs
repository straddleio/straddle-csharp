...
public class ChargeReleaseParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ChargeReleaseParams
        {
    ...
    {
        ChargeReleaseParams parameters = new() { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };

        var url = parameters.Url(new() { ApiKey = "My API Key" });

        Assert.Equal(
            new Uri(
                "https://sandbox.straddle.com/v1/charges/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/release"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        ChargeReleaseParams copied = new(parameters);
