...
public class ReportCreateTotalCustomersByStatusParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ReportCreateTotalCustomersByStatusParams
        {
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReportCreateTotalCustomersByStatusParams copied = new(parameters);
