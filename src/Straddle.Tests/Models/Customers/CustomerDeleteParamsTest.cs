...
public class CustomerDeleteParamsTest : TestBase
{
    ...
    {
        var parameters = new CustomerDeleteParams
        {
    ...
    {
        var parameters = new CustomerDeleteParams { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
    ...
    {
        CustomerDeleteParams parameters = new() { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
