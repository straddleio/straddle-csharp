...
public class CustomerGetParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CustomerGetParams
        {
    ...
    {
        var parameters = new CustomerGetParams { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
    ...
    {
        CustomerGetParams parameters = new() { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        CustomerGetParams copied = new(parameters);
