...
public class ReviewGetParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ReviewGetParams
        {
    ...
    {
        var parameters = new ReviewGetParams { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
    ...
    {
        ReviewGetParams parameters = new() { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };

        var url = parameters.Url(new() { ApiKey = "My API Key" });

        Assert.Equal(
            new Uri(
                "https://sandbox.straddle.com/v1/customers/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/review"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReviewGetParams copied = new(parameters);
