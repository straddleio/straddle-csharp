...
public class LinkedBankAccountUnmaskParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new LinkedBankAccountUnmaskParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(
            new Uri(
                "https://sandbox.straddle.com/v1/linked_bank_accounts/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/unmask"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        LinkedBankAccountUnmaskParams copied = new(parameters);
