...
public class RepresentativeCreateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new RepresentativeCreateParams
        {
        ...
        Relationship expectedRelationship = new()
        {
            Control = true,
            Owner = true,
            Primary = true,
    ...
    public void CopyConstructor_Works()
    {
        ...
        RepresentativeCreateParams copied = new(parameters);
