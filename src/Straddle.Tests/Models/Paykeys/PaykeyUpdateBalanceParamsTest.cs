...
public class PaykeyUpdateBalanceParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new PaykeyUpdateBalanceParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(
            new Uri(
                "https://sandbox.straddle.com/v1/paykeys/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/refresh_balance"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        PaykeyUpdateBalanceParams copied = new(parameters);
