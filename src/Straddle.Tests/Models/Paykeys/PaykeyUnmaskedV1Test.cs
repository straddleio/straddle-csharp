...
public class PaykeyUnmaskedV1DataSourceTest : TestBase
{
    ...
    [InlineData(PaykeyUnmaskedV1DataSource.Mastercard)]
...
public class PaykeyUnmaskedV1DataStatusDetailsReasonTest : TestBase
{
    ...
    [InlineData(PaykeyUnmaskedV1DataStatusDetailsReason.Validating)]
    [InlineData(PaykeyUnmaskedV1DataStatusDetailsReason.AutoHold)]
