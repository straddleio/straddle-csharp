...
public class PaykeyRevealParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new PaykeyRevealParams
        {
    ...
    {
        var parameters = new PaykeyRevealParams { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
    ...
    {
        PaykeyRevealParams parameters = new() { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };

        var url = parameters.Url(new() { ApiKey = "My API Key" });

        Assert.Equal(
            new Uri(
                "https://sandbox.straddle.com/v1/paykeys/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/reveal"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        PaykeyRevealParams copied = new(parameters);
