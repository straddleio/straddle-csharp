...
public class PayoutReleaseParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new PayoutReleaseParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(
            new Uri(
                "https://sandbox.straddle.com/v1/payouts/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/release"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        PayoutReleaseParams copied = new(parameters);
