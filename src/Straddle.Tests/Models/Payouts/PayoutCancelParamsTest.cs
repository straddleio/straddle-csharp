...
public class PayoutCancelParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new PayoutCancelParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.Equal(
            new Uri(
                "https://sandbox.straddle.com/v1/payouts/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/cancel"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        PayoutCancelParams copied = new(parameters);
