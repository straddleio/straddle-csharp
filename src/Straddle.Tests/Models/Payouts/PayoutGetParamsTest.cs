...
public class PayoutGetParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new PayoutGetParams
        {
    ...
    {
        var parameters = new PayoutGetParams { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
    ...
    {
        PayoutGetParams parameters = new() { ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e" };
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://sandbox.straddle.com/v1/payouts/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        PayoutGetParams copied = new(parameters);
