...
public class PayoutV1Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new PayoutV1
        {
            Data = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PayoutV1>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<PayoutV1>(
            element,
